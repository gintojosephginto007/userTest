...
const joi_custom_types_custom_1 = __importDefault(require("./joi-custom-types.custom"));
const Joi = joi_1.default.extend(joi_custom_types_custom_1.default);
...
exports.DateRangeAlternatives = Joi
    .alternatives()
    .try(exports.inputDateHypenYMD, exports.ValidateDateRange)
    .options({
    messages: {
...
//# sourceMappingURL=joi-custom-schema.js.map