...
const controller = new partner_controller_1.default();
const router = express_1.default.Router({ caseSensitive: true });
const validateRequest = partner_schema_validator_middleware_1.default(true, partner_schema_1.PartnerSchema);
